(function (root, factory) {
  ...
  Level.$metadata$ = {kind: Kind_CLASS, simpleName: 'Level', interfaces: [Enum]};
  ...
  Deflection.$metadata$ = {kind: Kind_CLASS, simpleName: 'Deflection', interfaces: [Enum]};
  ...
  MoveResult.$metadata$ = {kind: Kind_CLASS, simpleName: 'MoveResult', interfaces: [Enum]};
  ...
  Sounds.$metadata$ = {kind: Kind_OBJECT, simpleName: 'Sounds', interfaces: []};
  ...
  _.Arena = Arena;
  Object.defineProperty(Level, 'EASY', {get: Level$EASY_getInstance});
  Object.defineProperty(Level, 'NORMAL', {get: Level$NORMAL_getInstance});
  Object.defineProperty(Level, 'HARD', {get: Level$HARD_getInstance});
  _.Level = Level;
  ...
  _.Ball = Ball;
  Object.defineProperty(Deflection, 'BY_BAT', {get: Deflection$BY_BAT_getInstance});
  Object.defineProperty(Deflection, 'DEFAULT', {get: Deflection$DEFAULT_getInstance});
  Object.defineProperty(Deflection, 'RESTART', {get: Deflection$RESTART_getInstance});
  _.Deflection = Deflection;
  Object.defineProperty(MoveResult, 'HUMAN_LOSS', {get: MoveResult$HUMAN_LOSS_getInstance});
  Object.defineProperty(MoveResult, 'COMPUTER_LOSS', {get: MoveResult$COMPUTER_LOSS_getInstance});
